...
/*
    删除接口负责接收前端的文章删除请求，处理前端传输过来的数据后，将这些记录从数据库中删除(逻辑删除)
    将接受的参数设置为一个数组，可以同时删除多条记录，只需要在前端将用户选择的记录 id 封装好再传参到后端即可。
*/
    ...
    public void uploadFileByEditormd(HttpServletRequest request,
        ...
        String FILE_UPLOAD_DIC = "D:\\CODE\\Projects\\spring-myblog-18\\src\\main\\resources\\static\\upload\\imgs";
        //String FILE_UPLOAD_DIC = "D:\\CODE\\Projects\\pic\\";//上传文件的默认url前缀，根据部署设置自行修改
